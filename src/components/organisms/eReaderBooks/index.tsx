  ...
  return (
    <div className={className}>
      ...
      <div className={styles.horizontalView}>
        <EReadersCard
          src={
            "https://images-eu.ssl-images-amazon.com/images/I/41aTw6F6DDL._AC_SX184_.jpg"
          }
          rating={3}
        />
        <EReadersCard
          src={
            "https://images-eu.ssl-images-amazon.com/images/I/41FW4mTXMhL._AC_SX184_.jpg"
          }
          rating={4.5}
        />
        <EReadersCard
      ...
      <div className={styles.verticleView}>
        <StoreCard
          src={
            "https://images-eu.ssl-images-amazon.com/images/I/41-G7AIOZyL._AC_US218_.jpg"
          }
